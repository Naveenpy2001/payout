    ...
    <div className="home-page">
      ...
      <div className="container-main">
        <div className="search-containe">
          ...
          <div className="box-btns">
            <button className="buttton-search bg-blue-600 hover:bg-blue-500 cursor-pointer text-amber-50 p-3">Search</button>
          </div>
          </div>
        </div>
      </div>
        ...
        <div className="pc-main">
      {
        popular.map((pop,index) => (
          <div className="catefory" key={index}>
      ...
      <div className="fvc-category-content">
        ...
        <div className="fvc-tags">
          {data[activeCategory].map(item => (
            <Link
              to={`/jobs?${activeCategory.toLowerCase()}=${encodeURIComponent(item)}`}
              key={item}
